...
The formula for the sum of the series 1+2+...+n is n(n+1)/2. What if we weren’t sure that was the right function? How could we check? Using what we learned about functions we can create one that computes the  
Sn:
