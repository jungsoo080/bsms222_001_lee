...
Bloomberg	    11/4-11/6     799LV            	3.5              	46.0            	43.0       	Clinton +3
IBD	          11/4-11/7     1107LV	          3.1             	43.0             	42.0       	Clinton +1
Economist	    11/4-11/7	    3669LV	           –	              49.0            	45.0      	Clinton +4
LA Times	    11/1-11/7   	2935LV	          4.5             	44.0            	47.0        	Trump +3
ABC	          11/3-11/6   	2220LV	          2.5             	49.0	            46.0      	Clinton +3
FOX News	    11/3-11/6    	1295LV          	2.5             	48.0            	44.0      	Clinton +4
Monmouth	    11/3-11/6	     748LV           	3.6             	50.0            	44.0	      Clinton +6
NBC News	    11/3-11/5	    1282LV	          2.7	              48.0	            43.0      	Clinton +5
CBS News	    11/2-11/6   	1426LV	          3.0             	47.0            	43.0      	Clinton +4
Reuters	      11/2-11/6	    2196LV           	2.3             	44.0	            39.0	      Clinton +5
...
```{r}
knitr::include_graphics("four-simulated-polls-1.png")
```
...
```{r}
knitr::include_graphics("1234.PNG")
```
...
Using what we have learned, the expected value of the sum N¯X is N × the average of the urn, p. So dividing by the non-random constant N gives us that the expected value of the average ¯X is p. We can write it using our mathematical notation:
...
```{r}
knitr::include_graphics("standard-error-versus-sample-size-1.png")
```
