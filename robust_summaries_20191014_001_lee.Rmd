...
Q1 and Q3 respectively, then an outlier is anything outside the range:

                       [Q1−1.5×(Q3−Q1),Q3+1.5×(Q3−Q1)]
                      

When the data is normally distributed, the standard units of these values are:When the data is normally distributed, the standard units of these values are:
...
2. Compute the standard deviation and median absolute deviation of these data.
