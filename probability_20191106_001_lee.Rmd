...
```{r}
knitr::include_graphics("plot-of-height-frequencies-1.png")
```
...
```{r}
knitr::include_graphics("continuous-probability.png")
```
...
```{r}
knitr::include_graphics("intergrals-1.png")
```
...
```{r}
knitr::include_graphics("simulated-heights-1.png")
```
...
```{r}
knitr::include_graphics("simulated-tallest-height-1.png")
```
...
```{r}
knitr::include_graphics("snr.png")
```
...
```{r}
highest_IQ <- replicate(1000, max(rnorm(10000, 100, 15)))
hist(highest_IQ)
```

-------------------------------------------------------------------------------------

43. https://en.wikipedia.org/wiki/Urn_problem↩

44. https://www.khanacademy.org/math/precalculus/prob-comb/dependent-events-precalc/v/monty-hall-problem↩

45. https://en.wikipedia.org/wiki/Monty_Hall_problem↩